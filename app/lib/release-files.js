...
const APP_FILES = ['package.json', 'LICENSE', 'server.js', 'seed.js', 'recovery-assistant.js', 'update-assistant.js', 'RUNBOOK.md', 'update-public-key.pem'];
...
const TRIAL_SEED_FILES = ['seed-mock-day.js', 'seed-mock-clinic.js'];
