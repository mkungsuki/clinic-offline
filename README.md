...
### [⬇ ดาวน์โหลดเพื่อทดลองใช้](https://github.com/mkungsuki/mk-artifacts/releases/download/v1.0.8/01-Clinic-Demo-1.0.8.zip)

**เริ่มจากปุ่มนี้ถ้าเพิ่งลองครั้งแรก** มีข้อมูลสมมติให้ฝึก ห้ามใส่ข้อมูลคนไข้จริง

### [⬇ ดาวน์โหลดเพื่อใช้งานจริง](https://github.com/mkungsuki/mk-artifacts/releases/download/v1.0.8/02-Clinic-Install-1.0.8.zip)

สำหรับเริ่มใช้ที่คลินิก ฐานข้อมูลเริ่มว่าง

ทั้งสองชุดเป็นรุ่น **1.0.8** ขนาดประมาณ **76 MB** มีส่วนประกอบครบ ไม่ต้องสมัคร GitHub หรือลง Git / Node.js เพิ่ม

### โหลดแล้วทำตามนี้

1. กด **ดาวน์โหลดเพื่อทดลองใช้** ด้านบน แล้วรอจนโหลดเสร็จ
2. ใน Edge กด **Ctrl+J** → **แสดงในโฟลเดอร์** เพื่อหาไฟล์ที่เพิ่งโหลด
3. ชุดทดลองชื่อ **01-Clinic-Demo-1.0.8.zip**; ชุดจริงชื่อ **02-Clinic-Install-1.0.8.zip**
...
[สิ่งที่เพิ่มใน 1.0.8 และขั้นตอนอัปเดต](https://github.com/mkungsuki/mk-artifacts/releases/tag/v1.0.8)
