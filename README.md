...
## เลิกใช้เดโมก่อนเริ่มงานจริง (เพิ่มในรุ่น 1.0.16)

ที่เครื่องหลัก ให้ทุกเครื่องหยุดใช้ชุดทดลอง แล้วเปิด `C:\clinic-trial` → ดับเบิลคลิก **ถอนชุดทดลอง.cmd** → ยืนยันลบข้อมูลฝึก → รอข้อความแจ้งว่าถอนเสร็จ หากติดขัดให้กด **ลองอีกครั้ง** ในหน้าต่างตัวถอน จากนั้นจึงเปิดตัวติดตั้งชุดใช้งานจริง ข้อมูลเดโมไม่ย้ายไปฐานจริง

ชุดทดลองที่ติดตั้งใหม่มีไฟล์ถอนให้ทันที ส่วนรุ่นเดิมให้อัปเดตแล้วเปิดโปรแกรมหนึ่งครั้ง หรือใช้ปุ่ม **ถอนชุดทดลองและข้อมูลฝึกทั้งหมด** ในหน้าจัดการชุดทดลอง ตัวติดตั้งจริงจะตรวจและทำงานถอนเดโมที่ค้างให้เสร็จก่อนติดตั้ง หากเคยใส่ข้อมูลคนไข้จริงในเดโม ให้ยกเลิกและเก็บข้อมูลที่ต้องใช้ก่อนลบ

ไฟล์ ZIP ที่ดาวน์โหลดและข้อมูลที่เคยส่งออกไป USB/คลาวด์ยังอยู่ การถอนเดโมไม่ลบฐานใช้งานจริง

## ประวัติการทำรายการสำหรับผู้ดูแล (เพิ่มในรุ่น 1.0.15)

เข้าบัญชี **ผู้ดูแล → ตั้งค่า / ดูแลคลินิก → ประวัติการทำรายการ** เพื่อค้นว่าใครทำอะไร เมื่อไร ใช้ช่องค้นเดียวสำหรับ HN ชื่อคนไข้ ชื่อยา เลขใบเสร็จ หรือชื่อผู้ใช้ เลือกช่วงวันนี้ 7 วัน 30 วัน หรือกำหนดวันเองได้

ประวัติแยกเป็น 6 หมวด: **คนไข้ · ยาและสต็อก · เงิน · เอกสาร · บัญชีผู้ใช้ · สำรองข้อมูล** มีทางลัด **ใครปรับยอดยา · ใครแก้ราคา/ทุน · บิลที่ยกเลิก/คืนเงิน · ใครแก้ข้อมูลคนไข้** กดรายการเพื่อดูข้อมูลก่อน–หลัง เหตุผล และเครื่องที่ทำเท่าที่มีบันทึกไว้ หน้าแรกแสดงรายการสำคัญ และเลือกแสดงรายการปกติด้วยได้

ประวัติการแก้ไขที่เพิ่มในรุ่นนี้เริ่มเก็บหลังอัปเดต ไม่มีการเติมประวัติเก่าที่ไม่เคยบันทึก หากกู้ข้อมูล ประวัติจะย้อนตามสำเนาที่กู้ หน้าประวัติรวมนี้เปิดได้เฉพาะบัญชีผู้ดูแล

## ลงทะเบียนคลินิกได้จากโปรแกรม (เพิ่มในรุ่น 1.0.14)

เปิด **เกี่ยวกับโปรแกรม → ลงทะเบียนคลินิก (สมัครใจ)** เพื่อบอกเราเกี่ยวกับคลินิกและข้อเสนอแนะ ผู้ดูแลเข้าจาก **ตั้งค่า / ดูแลคลินิก → อัปเดตและเกี่ยวกับโปรแกรม** ปุ่มเปิด Google Forms ในแท็บใหม่และต้องเชื่อมต่ออินเทอร์เน็ต กรอกโดยสมัครใจ ไม่กรอกก็ใช้โปรแกรมได้ครบ
